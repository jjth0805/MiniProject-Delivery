...
<script>
  ...
  <body>
    ...
    <form id="updateForm" action="<c:url value='/board/boardUpdate'/>" method="post">
        <div class="row">
        <div class="col-md-7 mb-5" id="readtable">
            <table>
                ...
                <tr>
                    <th>제목</th>
                    <td colspan="3"><input type="text" name="title" value="${vo.title}" required="required"></td>
                </tr>
                <tr>
                    <th>내용</th>
                    <td colspan="3"><textarea rows="5" name="content" required="required"class="form-control">${vo.content}</textarea></td>
                </tr>
            </table>
            <br>
                <div class="row form-group">
                        <div class="col-md-6">
                           <input type="button" value="수정" onclick="updateComplete()" class="btn btn-primary py-2 px-4 text-white">
                           <a href="<c:url value='/board/boardRead?boardNum=${requestScope.vo.boardNum}'/>">
                               <input type="button" value="취소" class="btn btn-primary py-2 px-4 text-white">
                           </a>
                        </div>
                 </div>
