		...
		$.ajax({
			...
			success : function(data){
	           ...
	           $.each(data, function(index, item){
			    	...
			    	searchData += ('<td><a href="<c:url value="/board/boardRead?boardNum='+item.boardNum+'"/>">'+item.title+'<a></td>');                    
...
<div class="site-blocks-cover inner-page-cover overlay" style="background-image: url(../resources/images/hero_bg_1.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
    ...
    <div class="col-xs-12 col-md-8">
		<form action="<c:url value='/board/getBoardList'/>" method="get">
    ...
    <table>
        ...
        <tr>
            ...
            <td id="title"><a href="<c:url value='/board/boardRead?boardNum=${board.boardNum}'/>">${board.title}</a></td>
            <td>${board.userId}</td>
            <td>${board.hit}</td>
