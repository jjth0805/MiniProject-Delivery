...
<html>
<head>
    <title>Delivery Notice Write</title>
    <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center text-center">
                ...
                <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
                    <h1 class="text-white font-weight-light text-uppercase font-weight-bold">Notice Form</h1>
                </div>
            </div>
        </div>
    </div>
<form action="<c:url value='/board/boardWrite'/>" method="post" onsubmit="return writeConfirm()" id="formadjust">
    <div class="row">
          <div class="col-md-7 mb-5" id="readtable">
                 <table>
                    <tr>
                        <th>작성자</th>
                        <th>${sessionScope.userId}</th>
                    </tr>
                    <tr>
                        <th>제목</th>
                ...
                <div class="row form-group">
                    <div class="col-md-6">
                        <input type="submit" value="확인" id="writeBtn" class="btn btn-primary py-2 px-4 text-white">
                            <a href="<c:url value='/board/getBoardList'/>"><input type="button" value="취소" class="btn btn-primary py-2 px-4 text-white"></a>
                    </div>
                </div>
          </div>
