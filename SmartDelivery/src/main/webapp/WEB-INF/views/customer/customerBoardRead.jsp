...
<script>
    function delConfirm() {
        if(confirm("삭제 하시겠습니까?")){
            location.href = "<c:url value='/customer/customerBoardDelete?boardNum=${vo.boardNum}'/>";
            }
    }
    function updateConfirm(){
        if(confirm("수정 화면으로 이동하시겠습니까?")){
            location.href = "<c:url value='/customer/customerBoardUpdateForm?boardNum=${requestScope.vo.boardNum}'/>";
            }
        }
</script>
<c:choose>
    ...
    <div class="row">
        <div class="col-md-7 mb-5" id="readtable">
            ...
            <div class="row form-group">
                    <div class="col-md-6">
                        <a href="<c:url value='/customer/getCustomerBoardList'/>"><input type="button" value="목록" class="btn btn-primary py-2 px-4 text-white"></a>
