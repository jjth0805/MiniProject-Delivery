...
<script>
  ...
  <body>
    ...
    <form id="updateForm" action="<c:url value='/customer/customerBoardUpdate'/>" method="post">
        <div class="row">
            ...
            <br>
                <div class="row form-group">
                        <div class="col-md-6">
                           ...
                           <a href="<c:url value='/customer/customerBoardRead?boardNum=${requestScope.vo.boardNum}'/>">
